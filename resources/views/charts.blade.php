...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="password.blade.php">Forgot Password</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="401.blade.php">401 Page</a>
                                            <a class="nav-link" href="404.blade.php">404 Page</a>
                                            <a class="nav-link" href="500.blade.php">500 Page</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.blade.php">Dashboard</a></li>
        ...
        <script src="startbootstrap-sb-admin-gh-pages/assets/demo/chart-pie-demo.js"></script>
    </body>
</html>
